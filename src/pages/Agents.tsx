      ...
      <div>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <p style={{ color: '#666', fontSize: '1.1rem', margin: 0 }}>
            Monitor and manage your AI agents with full CRUD operations. Each agent has specific capabilities and current operational status.
          </p>
          <div style={{ 
            marginTop: '1rem', 
            padding: '0.75rem', 
            ...
            💡 <strong>HTTP API Integration:</strong> All operations (Create, Read, Update, Delete) are handled through HTTP API calls with proper loading states and error handling.
          </div>
        </div>
